...
router.get("/", async (req, res) => {
    try {
                    ...
                    select: {
                        ...
                        CustomerSubscriptionPlan: {
                            select: {
                                startedAt: true,
                                exipresAt: true,
                                SubscriptionPlan: {select: {title: true, bandwidthLimit: true, storageLimit: true}},
                            },
                        },
                    },
                },
        ...
        user.Customer.CustomerSubscriptionPlan.SubscriptionPlan.bandwidthLimit = user.Customer.CustomerSubscriptionPlan.SubscriptionPlan.bandwidthLimit.toString();
        user.Customer.CustomerSubscriptionPlan.SubscriptionPlan.storageLimit = user.Customer.CustomerSubscriptionPlan.SubscriptionPlan.storageLimit.toString();
